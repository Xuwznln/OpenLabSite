...
&nbsp;&nbsp;
<a href="https://thinklab.sjtu.edu.cn/"><img src="public/brands/rethinklab.jpg" alt="Shanghai Jiao Tong University ReThinkLab" height="76" /></a>
&nbsp;&nbsp;&nbsp;&nbsp;
...
Further reading: [TypeScript SDK](packages/protocol/README.en.md) · [Architecture](docs/ARCHITECTURE.md) · [Protocol overview](docs/protocol/README.md) · [AI customization guide](docs/VIBE_GUIDE.md)
